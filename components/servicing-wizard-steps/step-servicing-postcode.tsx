...
interface StepServicingPostcodeProps {
  value: string;
  onNext: (postcode: string, coverageData: { outwardCode: string; coverageStatus: 'in_area' | 'out_of_area' }) => void;
  onOutOfArea: (postcode: string, outwardCode: string) => void;
}

export function StepServicingPostcode({ value, onNext, onOutOfArea }: StepServicingPostcodeProps) {
  ...
  const handleOutOfArea = () => {
    if (validationStatus.type === 'out_of_area') {
      onOutOfArea(validationStatus.formatted, validationStatus.outwardCode);
    }
  };
      ...
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            Enter your postcode to confirm we cover your area for servicing.
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="space-y-1">
                  <div className="flex items-start gap-2 text-sm text-green-700">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-0.5">You can continue to book your service.</p>
                    </div>
                  </div>
                </div>
              )}
