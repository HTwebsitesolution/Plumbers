...
interface StepRepairsPostcodeProps {
  value: string;
...
export function StepRepairsPostcode({ value, onNext, onOutOfArea }: StepRepairsPostcodeProps) {
      ...
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            Enter your postcode to confirm we cover your area for repairs.
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="space-y-1">
                  <div className="flex items-start gap-2 text-sm text-green-700">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mt-0.5">You can continue to request a repair.</p>
                    </div>
                  </div>
                </div>
              )}
