...
interface StepRepairsContactProps {
  value: ContactDetails;
  onNext: (data: ContactDetails) => void;
}

export function StepRepairsContact({ value, onNext }: StepRepairsContactProps) {
      ...
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            How should we get in touch to arrange your repair?
          </CardDescription>
        </CardHeader>
        <CardContent>
